...
public class Infinity extends Personaje {
	private boolean der;
	private boolean izq;
	...
	public Infinity(Logica log, float x, float y) {
		super(log, x, y);
	
		vistas[0] = app.loadImage("infinity-1.png");
		vistas[1] = app.loadImage("Infinity-atras.png");
		vistas[2] = app.loadImage("infinity-der.png");
		vistas[3] = app.loadImage("inifinity-izq.png");
