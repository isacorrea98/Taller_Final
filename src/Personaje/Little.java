...
public class Little extends Personaje {
	private boolean der;
	private boolean izq;
	...
	public Little(Logica log, float x, float y) {
		super(log, x, y);

		vistas[0] = app.loadImage("jugador.png");
		vistas[1] = app.loadImage("jugador.png");
		vistas[2] = app.loadImage("jugador.png");
		vistas[3] = app.loadImage("jugador.png");
